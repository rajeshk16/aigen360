...
Use Modules\OpenAI\Entities\{Content, Image, Code, Chat};
...
class AdminDashboardReportService
{
    ...
    public function codeGeneratedThisMonth($key = 'codeGeneratedThisMonth', $returnSelf = true)
    {
        ...
        $codeGenerated = Code::where('created_at', '>=', $this->offsetDate('-30'))->count();
    ...
    public function codeGeneratedThisMonthCompare($key = 'codeGeneratedThisMonthCompare')
    {
        ...
        $totalLastMonth = Code::where('created_at', '>=', $this->offsetDate('-60'))->where('created_at', '<', $this->offsetDate('-30'))->count();
    ...
    public function documentCreatedThisMonth($key = 'documentGeneratedThisMonth', $returnSelf = true)
    {
        ...
        $documentCreated = Content::where('created_at', '>=', $this->offsetDate('-30'))->count();
    ...
    public function documentCreatedThisMonthCompare($key = 'documentCreatedThisMonthCompare')
    {
        ...
        $totalLastMonth = Content::where('created_at', '>=', $this->offsetDate('-60'))->where('created_at', '<', $this->offsetDate('-30'))->count();
            ...
            $q->select('id', 'name as packageName');
                ...
                ->map(function ($transaction) {
                    return [
                        ...
                        'package_name' =>  $transaction?->package?->packageName,
