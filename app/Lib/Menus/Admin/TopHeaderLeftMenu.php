...
class TopHeaderLeftMenu
{
    ...
    {
        $addon = Addon::find('affiliate')->isEnabled();
        $affiliateIsEnable = $addon ? route('admin.affiliate.dashboard') : 'javascript: void(0)';
        $items = [
            'full_screen' => [
            ...
            'affiliate' => [
                'item' => '<a class="d-flex align-items-center text-decoration-none" href="' .  $affiliateIsEnable . '" target="_blank">
