"use strict";
var vErC = 'error';
var pErC = 'has-validation-error';
var i = document.querySelectorAll('.form-control');
...
function validationCheck(ids, $value) {
    let status = true;
    let inputElements = document.querySelectorAll($value);
