...
@section('logo', asset(moduleConfig('flutterwave.logo')))

@section('gateway', asset(moduleConfig('flutterwave.name')))
@section('content')
    <p class="para-6">{{ __('Fill in the required information') }}</p>
    <div class="straight-line"></div>
    <form action="{{ route('gateway.complete', withOldQueryIntegrity(['gateway' => moduleConfig('flutterwave.alias')])) }}"
