...
class OrdersCreateRequest
{
    ...
    public function getApiResponse()
    {
        ...
        $postData->merchantAttributes->redirectUrl = route(moduleConfig('gateway.payment_callback'), withOldQueryIntegrity(['gateway' => 'ngenius']));
        $postData->merchantAttributes->cancelUrl = route(moduleConfig('gateway.payment_cancel'), withOldQueryIntegrity(['gateway' => 'ngenius']));
