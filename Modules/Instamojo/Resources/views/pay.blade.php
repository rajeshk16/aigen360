...
@section('logo', asset(moduleConfig('instamojo.logo')))

@section('gateway', moduleConfig('instamojo.name'))
...
@section('content')
    ...
    <form class="pay-form needs-validation"
        action="{{ route('gateway.complete', withOldQueryIntegrity(['gateway' => moduleConfig('instamojo.alias')])) }}"
