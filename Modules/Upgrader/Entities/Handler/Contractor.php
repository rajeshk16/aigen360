...
class Contractor
{
    ...
    protected function setTempPath()
    {
        ...
        if (!is_dir($tempPath)) {
            File::makeDirectory($tempPath, config('app.filePermission'), true, true);
        }
    ...
    protected function setBackupDirectory()
    {
        ...
        if (!is_dir($backupDir)) {
            File::makeDirectory($backupDir, config('app.filePermission'), true, true);
        }
    ...
    {
        Env::set('ARTIFISM_VERSION', $version);
    }
