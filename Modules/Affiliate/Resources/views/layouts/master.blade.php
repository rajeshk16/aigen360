...
<head>
    ...
    @include('affiliate::layouts.includes.meta')
    <!-- Favicon icon -->
    @php
...
@include('affiliate::layouts.includes.sidebar')
<!-- [ navigation menu ] end -->

<!-- [ Header ] start -->
@include('affiliate::layouts.includes.header')
<!-- [ Header ] end -->
    ...
    <div class="pcoded-wrapper">
        <div class="pcoded-content">
            <div class="pcoded-inner-content">
                <!-- [ breadcrumb ] start -->
                @include('affiliate::layouts.includes.notifications')
