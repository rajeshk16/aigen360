    ...
    <div class="addon-modal-body">
        <div class="addon-modal-form-row">
            ...
            <div class="addon-modal-field">
                ...
                value="{{ config('openAI.is_demo') ? techEncrypt(env('NOCAPTCHA_SITEKEY')) : env('NOCAPTCHA_SITEKEY') }}">
            </div>
        </div>
        ...
        <div class="addon-modal-form-row">
            ...
            <div class="addon-modal-field">
                ...
                value="{{ config('openAI.is_demo') ? techEncrypt(env('NOCAPTCHA_SECRET')) : env('NOCAPTCHA_SECRET') }}">
            </div>
        </div>
