...
@section('logo', asset(moduleConfig('directbanktransfer.logo')))

@section('gateway', moduleConfig('directbanktransfer.name'))
...
@section('content')
    ...
    <div class="col-md-12 p-4 payment-box align-center mt-2">
        <form
            action="{{ route('gateway.complete', withOldQueryIntegrity(['gateway' => moduleConfig('directbanktransfer.alias')])) }}"
