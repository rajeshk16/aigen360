...
class CoinpaymentApi
{
    ...
    private function api_call($cmd, $req = array())
    {
        ...
        if ($this->ch === null) {
            ...
            curl_setopt($this->ch, CURLOPT_SSL_VERIFYPEER, moduleConfig('coinpayment.ssl_verify_peer'));
            curl_setopt($this->ch, CURLOPT_SSL_VERIFYHOST, moduleConfig('coinpayment.ssl_verify_host'));
        }
